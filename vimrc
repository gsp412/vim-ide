...
" 插入邮箱
imap <C-z><C-z> guoshuangpeng@letv.com
imap <C-g><C-g> Shuangpeng.guo
...
let g:mail = "guoshuangpeng@le.com"
let g:author = "Shuangpeng.guo"
...
func SetTitle()
    ...
    if &filetype == "sh"
        ...
        call append(line(".")+5, "## 作  者: # Shuangpeng.guo # ".strftime("%c").expand(" #"))
        call append(line(".")+6, "################################################################################")
